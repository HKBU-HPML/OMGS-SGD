...
os.environ['GPU_DEBUG']=os.environ['CUDA_VISIBLE_DEVICES']
...
if 'GPU_DEBUG' in os.environ:
    ...
    gpu_profile_fn = "Host_{}_gpu{}_mem_prof-{}.prof.txt".format(socket.gethostname(), os.environ['GPU_DEBUG'], datetime.datetime.now().strftime('%d-%b-%y-%H-%M-%S'))
        ...
        try:
            ...
            if lineno is not None:
                ...
                with open(gpu_profile_fn, 'a+') as f:
                    ...
                    f.write("{}"
                            ":{}Mb "
                            "{}\n".format(where_str, float(mem_display)/1024**2, line.rstrip()))
